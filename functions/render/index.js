...
var require_fetch = __commonJS({
  "node_modules/@supabase/gotrue-js/dist/main/lib/fetch.js"(exports) {
    ...
    exports.get = get2;
    function post2(url, body, options2) {
      return __awaiter(this, void 0, void 0, function* () {
...
var import_fastq = __toModule(require_queue());
var css$4 = {
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-488b9531.js",
      css: ["/./_app/assets/start-a8cd1609.css"],
      js: ["/./_app/start-488b9531.js", "/./_app/chunks/vendor-a14de98d.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = { ".svelte-kit/build/components/layout.svelte": { "entry": "/./_app/layout.svelte-c166948b.js", "css": [], "js": ["/./_app/layout.svelte-c166948b.js", "/./_app/chunks/vendor-a14de98d.js"], "styles": null }, ".svelte-kit/build/components/error.svelte": { "entry": "/./_app/error.svelte-f8099ec2.js", "css": [], "js": ["/./_app/error.svelte-f8099ec2.js", "/./_app/chunks/vendor-a14de98d.js"], "styles": null }, "src/routes/index.svelte": { "entry": "/./_app/pages/index.svelte-76be9a1a.js", "css": ["/./_app/assets/pages/index.svelte-d189ddb5.css"], "js": ["/./_app/pages/index.svelte-76be9a1a.js", "/./_app/chunks/vendor-a14de98d.js"], "styles": null } };
...
var supabase = (0, import_supabase_js.createClient)("https://rbgcndiqstjtznzhzpvr.supabase.co", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJyb2xlIjoiYW5vbiIsImlhdCI6MTYxMjM2NTcwNywiZXhwIjoxOTI3OTQxNzA3fQ.KHkZsRxjK6nxcJfFSs8svYnEGsCUORIOC_hXymTEkgs");
async function post(request) {
  console.log("submitting json");
  console.log(request);
  const { data, error: error22 } = await supabase.from("native_here").insert([
    {
...
var publish_location = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  post
});
var get = async () => {
  try {
    const { data: table, error: error22 } = await supabase.from("native_here").select("*");
    return {
      body: JSON.stringify({ table, error: error22 })
    };
  } catch (e) {
    console.log({ e });
    return {
...
var load_sites = /* @__PURE__ */ Object.freeze({
  __proto__: null,
  [Symbol.toStringTag]: "Module",
  get
});
...
var EventQueue = class {
  constructor(worker) {
    this.queue = new import_fastq.default(this, worker, 1);
    this.queue.pause();
  }
  send(command, params = []) {
    if (!command) {
...
var Map2 = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  function fitBounds(bbox, options3 = {}) {
    queue.send("fitBounds", [bbox, options3]);
  }
  function flyTo(destination, options3 = {}) {
    queue.send("flyTo", [destination, options3]);
  }
  function resize() {
    queue.send("resize");
  }
  ...
  function setZoom(zoom2, eventData = {}) {
    queue.send("setZoom", [zoom2, eventData]);
  }
  function onAvailable() {
    window.mapboxgl.accessToken = accessToken;
    mapbox = window.mapboxgl;
...
create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  ready && value && geocoder && geocoder.setInput(value);
  return `<div${add_attribute("id", fieldId, 0)} class="${"svelte-1k1b3t4"}"${add_attribute("this", container, 1)}></div>`;
});
...
create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const geolocate = new mapbox.GeolocateControl(options2);
...
create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { options: options2 = {} } = $$props;
  const nav = new mapbox.NavigationControl(options2);
...
create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { options: options2 = {} } = $$props;
  const optionsWithDefaults = Object.assign({ maxWidth: 80, unit: "metric" }, options2);
...
${`<div class="${"opening_modal svelte-19swii9"}">
  <div class="${"modal-content"}" style="${"position: absolute; top: 20%; text-align: center; padding: 20px;"}"><h1 style="${"margin-left: -20px;"}">\u{1F331} Native</h1>
  <p style="${"font-size: 20px;"}">Walk to an outdoor place and share your location.</p>
  <button style="${"font-size: 18px; background: #d2f7a1;"}">\u{1F33F} I&#39;m outside \u{1F33F}</button></div></div>`}

<div class="${"section-txt"}" id="${"map"}"><div class="${"map-wrap svelte-19swii9"}">${validate_component(Map2, "Map").$$render($$result, {
      accessToken: "pk.eyJ1IjoibGV0b3VycG93ZXJzY29tYmluZSIsImEiOiJjazFmN3N0eTUwb3JwM2JwYWk4ZXB1enNtIn0._UjpOqZIeiWqhscosubipw",
      center,
      style,
      this: mapComponent,
    ...
    ${validate_component(Marker, "Marker").$$render($$result, { color: "skyblue", lat, lng }, {
        lat: ($$value) => {
          lat = $$value;
          $$settled = false;
        },
    ...
    ${sites ? `${each(sites, (site) => `${validate_component(Marker, "Marker").$$render($$result, {
        lng: site.lng,
        lat: site.lat,
        label: site.title,
        type: site.title,
        ...
        default: () => `<div style="${"font-size: 26px;"}">${site.type == "plant_here" ? `\u2757` : `${site.type == "plant_with_peers" ? `\u{1F91D}\u{1F3FC}` : `${site.type == "plant_learn" ? `\u{1F34E}
          ` : `${site.type == "seed_share" ? `\u{1F331}
          ` : `${site.type == "peer" ? `\u{1F596}` : ``}`}`}`}`}</div>
      `
      })}`)}` : ``}`
    })}

  <div class="${"info_panel svelte-19swii9"}">${local_species_loaded == true ? `<p style="${"margin-bottom: 5px;"}">[${escape2(lng.toFixed(4))}, ${escape2(lat.toFixed(4))}]</p>
    <p style="${"margin-top: 10px;"}">Local Species:</p>
    <ul style="${"text-align: left; margin-left: -15px;"}"><li style="${"margin-bottom: 10px;"}">
        White clover (Trifolium repens)</li>
      <li style="${"margin-bottom: 10px;"}">Yarrow (Achillea millefolium)</li>
      <li>Nettle (Urtica dioica)</li></ul>` : ``}
    ${local_species_loaded == false ? `${validate_component(LoadingSpinner, "LoadingSpinner").$$render($$result, {}, {}, {})}` : ``}</div>

  ${``}


  <div class="${"interaction svelte-19swii9"}" style="${"position: absolute; bottom: 15%"}">${menu_display.substr(0, 5) == "plant" ? `<button style="${"display: block;"}" class="${"svelte-19swii9"}">Learn to plant</button>
    ${``}
    <button style="${"display: block;"}" class="${"svelte-19swii9"}">Plant with peers</button>
    ${``}
    <button style="${"display: block;"}" class="${"svelte-19swii9"}">Someone, plant here!</button>
    ${``}
    <hr>
    <button style="${"display: block;"}" class="${"svelte-19swii9"}">Have something to offer?</button>` : `<button style="${"display: block;"}" class="${"svelte-19swii9"}">Seeds + plants to share.</button>
    ${``}
    <button style="${"display: block;"}" class="${"svelte-19swii9"}">I&#39;m a planter, willing to help others.</button>
    ${``}
    <hr>
    <button style="${"display: block;"}" class="${"svelte-19swii9"}">Want to plant something?</button>`}</div></div>
